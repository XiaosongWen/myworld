...
| 3 | Legacy habit/task tables | Old `habits`, `habit_logs`, `tasks`, `subtasks`, `projects` tables exist from earlier Phase 2 work. Need migration to new `commitments`, `records`, `commitment_links` schema. | Low | 2026-07-15 | — |
